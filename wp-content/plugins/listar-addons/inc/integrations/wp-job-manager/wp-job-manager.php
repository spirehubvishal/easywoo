...
if ( ! function_exists( 'listar_frontend_add_jobmanager_fields' ) ) :
	...
	function listar_frontend_add_jobmanager_fields( $fields ) {
		...
		$tags_enabled = (int) get_option( 'listar_use_search_listing_tags_data' );
		...
		if ( is_user_logged_in() ) :
			...
			$fields['job']['job_business_use_products'] = array(
				'label'       => esc_html__( 'Show My Products', 'listar' ),
				'type'        => 'checkbox',
				'required'    => false,
				'description' => esc_html__( 'Check to display your products(s).', 'listar' ),
				'priority'    => 5.974,
			);

			$products_label_options = array(
				'both'      => esc_html__( 'Products/Services', 'listar' ),
			...
			$fields['job']['job_business_products_label'] = array(
				'label'       => esc_html__( 'Label for Products section', 'listar' ),
				'type'        => 'select',
				'required'    => false,
				'options'     => $products_label_options,
				'description' => esc_html__( 'Select a label for Products section.', 'listar' ),
				'priority'    => 5.975,
			);

			$fields['job']['job_business_products_custom_label'] = array(
				'label'       => esc_html__( 'Custom Label for Products section.', 'listar' ),
				'type'        => 'text',
				'required'    => false,
				'placeholder' => esc_html__( 'Purchase', 'listar' ),
				'description' => esc_html__( 'Type a custom text to rename the section.', 'listar' ),
				'priority'    => 5.976,
			);
			...
			$products = listar_get_user_products_titles();
			$descr = esc_html__( 'Select products to display.', 'listar' );
			
			if ( empty( $products ) ) {
				$descr = esc_html__( "You don't have products published.", 'listar' );
			}
			
			$fields['job']['job_business_products_list'] = array(
				'label'       => esc_html__( 'My Products', 'listar' ),
				'type'        => 'multiselect',
				'required'    => false,
				'options'     => $products,
				'description' => $descr,
		...
		if ( 0 === $listar_booking_service_disable ) {
			$fields['job']['job_business_use_booking'] = array(
				'label'       => esc_html__( 'Bookings & Appointments', 'listar' ),
				'type'        => 'checkbox',
				'required'    => false,
				'description' => esc_html__( 'Check to set a booking/appointment service.', 'listar' ),
				'priority'    => 5.9824,
			);
			...
			$appointment_methods = array(
				'none'       => esc_html__( 'None', 'listar' ),
				'external'   => esc_html__( 'External', 'listar' ),
			);
			
			if ( class_exists( 'WC_Bookings' ) ) {
				$appointment_methods = array(
					'none'       => esc_html__( 'None', 'listar' ),
					'booking'    => esc_html__( 'My Bookable Product', 'listar' ),
					'external'   => esc_html__( 'External', 'listar' ),
				);
			}

			$fields['job']['job_business_booking_method'] = array(
				'label'       => esc_html__( 'Appointment Method', 'listar' ),
				'type'        => 'select',
				'required'    => false,
				'options'     => $appointment_methods,
				'description' => esc_html__( 'Select a method for appointments', 'listar' ),
				'priority'    => 5.98265,
			);
		...
		$listar_use_rich_media = (int) get_option( 'listar_rich_media_disable' );

		if ( 0 === $listar_use_rich_media ) {
			$fields['company']['company_use_rich_media'] = array(
				'label'       => esc_html__( 'Videos and Other Media', 'listar' ),
				'type'        => 'checkbox',
				'required'    => false,
				'description' => esc_html__( 'Create a mixed gallery of videos (e.g Youtube, Vimeo, .mp4), images, iframes and other rich media, like Google Street View or 3D tours.', 'listar' ),
				'priority'    => 1.01,
			);

			$media_label_options = array(
			...
			$fields['company']['company_business_rich_media_label'] = array(
				'label'       => esc_html__( 'Section label', 'listar' ),
				'type'        => 'select',
				'required'    => false,
				'options'     => $media_label_options,
				'description' => esc_html__( 'Select a label for the section.', 'listar' ),
				'priority'    => 1.02,
			);

			$fields['company']['company_business_rich_media_custom_label'] = array(
				'label'       => esc_html__( 'Custom Label for Videos and Other Media section.', 'listar' ),
				'type'        => 'text',
				'required'    => false,
				'placeholder' => esc_html__( 'Enter a label', 'listar' ),
				'description' => esc_html__( 'Type a single word (preferable) to name the section. It is recommended a maximum of 15 letters.', 'listar' ),
				'priority'    => 1.021,
			);

			$fields['company']['company_business_rich_media_append_gallery'] = array(
				'label'       => esc_html__( 'Append the Gallery of Images at the end', 'listar' ),
				'type'        => 'checkbox',
				'required'    => false,
				'description' => esc_html__( 'Join the gallery of images with this list of varied media.', 'listar' ),
				'priority'    => 1.022,
			);

			$fields['company']['company_business_rich_media_values'] = array(
				'label'       => '',
				'type'        => 'textarea',
				'required'    => false,
				'priority'    => 1.026,
		...
		if ( 0 === $listar_social_networks_disable ) {
			...
			$fields['company']['company_twitch'] = array(
				'label'       => 'Twitch',
				'type'        => 'text',
				'required'    => false,
				'placeholder' => esc_html__( 'Username or URL', 'listar' ),
			...
			$fields['company']['company_tiktok'] = array(
				'label'       => 'Tiktok',
				'type'        => 'text',
				'required'    => false,
				'placeholder' => esc_html__( 'Username or URL', 'listar' ),
			...
			$fields['company']['company_snapchat'] = array(
				'label'       => 'Snapchat',
				'type'        => 'text',
				'required'    => false,
				'placeholder' => esc_html__( 'Username or URL', 'listar' ),
		...
		$fields['job']['job_business_raw_contents'] = array(
			'label'       => 'xxxxxxxxxxxx',
			'type'        => 'textarea',
			'required'    => false,
			'priority'    => 999999,
...
if ( ! function_exists( 'listar_sanitize_listing_data_and_save_frontend' ) ) :
	...
	function listar_sanitize_listing_data_and_save_frontend( $post_id, $values ) {
		...
		if ( isset( $values['company']['company_twitch'] ) ) {
			$input = listar_sanitize_twitch( $values['company']['company_twitch'] );
			update_post_meta( $post_id, '_company_twitch', $input );
		}

		if ( isset( $values['company']['company_tiktok'] ) ) {
			$input = listar_sanitize_tiktok( $values['company']['company_tiktok'] );
			update_post_meta( $post_id, '_company_tiktok', $input );
		}

		if ( isset( $values['company']['company_snapchat'] ) ) {
			$input = listar_sanitize_snapchat( $values['company']['company_snapchat'] );
			update_post_meta( $post_id, '_company_snapchat', $input );
		}
		...
		if ( isset( $values['company']['company_business_rich_media_values'] ) ) {
			$input = $values['company']['company_business_rich_media_values'];
			update_post_meta( $post_id, '_company_business_rich_media_values', $input );
		}
...
if ( ! function_exists( 'listar_sanitize_listing_data_and_save_backend' ) ) :
	...
	function listar_sanitize_listing_data_and_save_backend( $post_id, $post, $update ) {
		...
		if ( 'job_listing' === $post_type ) {
			...
			$twitch          = get_post_meta( $post_id, '_company_twitch', true );
			$tiktok          = get_post_meta( $post_id, '_company_tiktok', true );
			$snapchat          = get_post_meta( $post_id, '_company_snapchat', true );
			...
			if ( ! empty( $twitch ) ) {
				$sanitized = listar_sanitize_twitch( $twitch );

				if ( $sanitized !== $twitch ) {
					update_post_meta( $post_id, '_company_twitch', $sanitized );
				}
			}

			if ( ! empty( $tiktok ) ) {
				$sanitized = listar_sanitize_tiktok( $tiktok );

				if ( $sanitized !== $tiktok ) {
					update_post_meta( $post_id, '_company_tiktok', $sanitized );
				}
			}

			if ( ! empty( $snapchat ) ) {
				$sanitized = listar_sanitize_snapchat( $snapchat );

				if ( $sanitized !== $snapchat ) {
					update_post_meta( $post_id, '_company_snapchat', $sanitized );
				}
			}
...
if ( ! function_exists( 'listar_backend_add_jobmanager_fields' ) ) :
	...
	function listar_backend_add_jobmanager_fields( $fields ) {
		...
		if ( 0 === $listar_use_rich_media ) {
			$fields['_company_use_rich_media'] = array(
				'label'       => esc_html__( 'Videos and Other Media', 'listar' ),
				'type'        => 'checkbox',
				'required'    => false,
				'description' => esc_html__( 'Create a mixed gallery of videos (e.g Youtube, Vimeo, .mp4), images, iframes and other rich media, like Google Street View or 3D tours.', 'listar' ),
			...
			$fields['_company_business_rich_media_label'] = array(
				'label'       => esc_html__( 'Section label', 'listar' ),
				'type'        => 'select',
				'required'    => false,
				'options'     => $media_label_options,
			...
			$fields['_company_business_rich_media_custom_label'] = array(
				'label'       => esc_html__( 'Custom Label for Videos and Other Media section.', 'listar' ),
				'type'        => 'text',
				'required'    => false,
				'placeholder' => esc_html__( 'Enter a label', 'listar' ),
			...
			$fields['_company_business_rich_media_append_gallery'] = array(
				'label'       => esc_html__( 'Append the Gallery of Images at the end', 'listar' ),
				'type'        => 'checkbox',
				'required'    => false,
				'description' => esc_html__( 'Join the gallery of images with this list of varied media.', 'listar' ),
			...
			$fields['_company_business_rich_media_values'] = array(
				'label'       => '',
				'type'        => 'textarea',
				'required'    => false,
				'priority'    => 3.066,
		...
		if ( 0 === $listar_social_networks_disable ) {
			...
			$fields['_company_snapchat'] = array(
				'label'       => 'Snapchat',
				'type'        => 'text',
				'placeholder' => esc_html__( 'Username or URL', 'listar' ),
				'description' => '',
		...
		if ( is_user_logged_in() ) :
			$fields['_job_business_use_products'] = array(
				'label'       => esc_html__( 'Show My Products', 'listar' ),
				'type'        => 'checkbox',
				'required'    => false,
				'description' => esc_html__( 'Check to display your products(s).', 'listar' ),
			...
			$fields['_job_business_products_label'] = array(
				'label'       => esc_html__( 'Label for Products section', 'listar' ),
				'type'        => 'select',
				'required'    => false,
				'options'     => $products_label_options,
			...
			$fields['_job_business_products_custom_label'] = array(
				'label'       => esc_html__( 'Custom Label for Products section.', 'listar' ),
				'type'        => 'text',
				'required'    => false,
				'placeholder' => esc_html__( 'Purchase', 'listar' ),
			...
			$fields['_job_business_products_list'] = array(
				'label'       => esc_html__( 'My Products', 'listar' ),
				'type'        => 'multiselect',
				'required'    => false,
				'options'     => $products,
		...
		if ( 0 === $listar_booking_service_disable ) {
			...
			$fields['_job_business_booking_method'] = array(
				'label'       => esc_html__( 'Appointment Method', 'listar' ),
				'type'        => 'select',
				'required'    => false,
				'options'     => $appointment_methods,
		...
		$fields['_job_business_raw_contents'] = array(
			'label'       => 'xxxxxxxxx',
			'type'        => 'textarea',
			'required'    => false,
			'priority'    => 999999,
	...
	function listar_modify_frontend_jobmanager_fields( $fields ) {
		...
		if ( ! empty( $disabled_package_options ) ) {
			...
			if ( isset( $disabled_package_options['listar_disable_company_youtube'] ) ) :
				...
				if ( isset( $fields['company']['company_use_rich_media'] ) ) :
					unset( $fields['company']['company_use_rich_media'] );
				endif;

				if ( isset( $fields['company']['company_business_rich_media_label'] ) ) :
					unset( $fields['company']['company_business_rich_media_label'] );
				endif;

				if ( isset( $fields['company']['company_business_rich_media_custom_label'] ) ) :
					unset( $fields['company']['company_business_rich_media_custom_label'] );
				endif;

				if ( isset( $fields['company']['company_business_rich_media_append_gallery'] ) ) :
					unset( $fields['company']['company_business_rich_media_append_gallery'] );
				endif;

				if ( isset( $fields['company']['company_business_rich_media_values'] ) ) :
					unset( $fields['company']['company_business_rich_media_values'] );
				endif;
			...
			if ( isset( $disabled_package_options['listar_social_networks_disable'] ) ) :
				...
				if ( isset( $fields['company']['company_twitch'] ) ) :
					unset( $fields['company']['company_twitch'] );
				endif;

				if ( isset( $fields['company']['company_tiktok'] ) ) :
					unset( $fields['company']['company_tiktok'] );
				endif;

				if ( isset( $fields['company']['company_snapchat'] ) ) :
					unset( $fields['company']['company_snapchat'] );
				endif;
...
if ( ! function_exists( 'listar_modify_backend_jobmanager_fields' ) ) :
	...
	function listar_modify_backend_jobmanager_fields( $fields ) {
		...
		$fields['_company_twitter']['priority']    = 5.15;
                $fields['_job_location']['priority']       = 1.0004;
