...
/**
 * Store Vendors Widget, extends the WCFM Marketplace Store Best Selling Vendors Widget
 *
 * @since 1.4.7
 *
 */
class Listar_WCFMmp_Store_Vendors extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 'classname' => 'wcfmmp-store-best-selling-vendors', 'description' => __( 'Store Vendors', 'listar' ) );
		parent::__construct( 'listar-wcfmmp-store-vendors', __( 'Marketplace: Vendors', 'listar' ), $widget_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		$vendors = $WCFMmp->wcfmmp_vendor->wcfmmp_get_vendor_list( true, '', $number );
		if ( isset( $vendors ) && count( $vendors ) ) {
			...
			$WCFMmp->template->get_template( 'store/widgets/wcfmmp-view-vendors.php', $template_args );
...
register_widget( 'Listar_WCFMmp_Store_Vendors' );
