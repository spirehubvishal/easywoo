<?php
/**
 * Template part output listing posts
 *
...
<div class="col-xs-12 col-sm-6 col-md-4 listar-grid-design-2 listar-listing-card <?php echo esc_attr( listar_sanitize_html_class( $listar_cards_design_class . ' ' . $listar_featured . ' ' . $listar_listing_id ) ); ?>">
	<article id="post-<?php the_ID(); ?>" <?php post_class( $listar_post_classes ); ?> data-aos="fade-zoom-in" data-aos-group="listings">
		<?php
