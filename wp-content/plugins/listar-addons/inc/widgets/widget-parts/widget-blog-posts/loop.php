...
$listar_col_class           = 'col-xs-12 col-sm-6 col-md-4 listar-grid-design-1 listar-blog-card';
$listar_excerpt             = listar_excerpt_limit( $post, 240 );
...
<!-- Start Blog Item Col -->
<div class="<?php echo esc_attr( listar_sanitize_html_class( $listar_col_class ) ); ?>">
	<article id="post-<?php the_ID(); ?>" <?php post_class( $listar_post_classes ); ?> data-aos="fade-zoom-in" data-aos-group="posts">
