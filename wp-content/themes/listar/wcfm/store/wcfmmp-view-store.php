...
$listar_sidebar_position = 'listar-sidebar-position-' . $store_sidebar_pos;
...
if ( $WCFMmp->wcfmmp_vendor->is_store_sidebar() && ($store_sidebar_pos != 'left' ) ) {
	$listar_sidebar_position = 'listar-sidebar-position-right';
}
?>
<style>
...
<div id="wcfmmp-store" class="wcfmmp-single-store-holder <?php echo $wcfm_store_wrapper_class; ?>">
	<div id="wcfmmp-store-content" class="wcfmmp-store-page-wrap woocommerce" role="main">
		...
		<section class="listar-section listar-woo-section">
			<div class="listar-container-wrapper" >
				<div class="container">
					...
					<div class="row <?php echo esc_attr( listar_sanitize_html_class( $listar_sidebar_position ) ); ?>">
						...
						<?php
						if ( $listar_has_sidebar && $store_sidebar_active ) :
							if ( apply_filters( 'wcfmmp_is_allow_mobile_sidebar_at_bottom', true ) ) {
								$WCFMmp->template->get_template( 'store/wcfmmp-view-store-sidebar.php', array( 'store_user' => $store_user, 'store_info' => $store_info ) );
							}
						endif;
