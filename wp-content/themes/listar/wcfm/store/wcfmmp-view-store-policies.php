...
<div class="_area" id="policy">
	<div class="wcfmmp-store-policies">
	  ...
	  <?php do_action( 'wcfmmp_store_before_policies', $store_user->get_id() ); ?>
		...
		<?php if( wcfm_empty( $shipping_policy ) && wcfm_empty( $refund_policy ) && wcfm_empty( $cancellation_policy ) ) { ?>
			<div class="policies_area wcfm-cancellation-policies">
				<h2 class="wcfm_policies_heading">
					<?php esc_html_e( 'Missing Policy Description(s)', 'listar' ); ?>
				</h2>
				<div class="wcfm_policies_description" >
					<?php esc_html_e( 'Store owner, please write at least on of these: Shipping Policy, Refund Policy, Cancellation Policy', 'listar' ); ?>
				</div>
			</div>
		<?php } ?>
