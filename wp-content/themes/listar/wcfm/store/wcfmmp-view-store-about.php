...
$temp = str_replace( array( "'", '<p>', '</p>', '<br data-mce-bogus="1">' ), '', preg_replace( '/\s*\R\s*/', ' ', trim( $wcfm_shop_description ) ) );

if ( empty( $temp ) ) :
	$wcfm_shop_description = esc_html__( 'Store owner, please write something about your business.', 'listar' );
endif;
