...
?>
  ...
  <div class="reviews_area reviews_add_area reviews_area_live">
		...
		<div class="write_review">
			<div class="lft review_photo">
				<img class="listar-background-cover-image" src="<?php echo esc_attr( $listar_blank_placeholder ); ?>" style="background-image:url(<?php echo esc_url( $wp_user_avatar ); ?>);" alt="Review"/>
			</div>
