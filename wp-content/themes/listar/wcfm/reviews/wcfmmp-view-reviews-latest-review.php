		...
		<div class="lft user_photo">
			<div class="review_photo">
			  <?php
				...
				?>
				<img class="listar-background-cover-image" src="<?php echo esc_attr( $listar_blank_placeholder ); ?>" style="background-image:url(<?php echo apply_filters( 'wcfmmp_review_author_avatar', $wp_user_avatar, $latest_review ); ?>);" alt="Review"/>
			</div>
