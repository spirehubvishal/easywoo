	...
	<div class="famous_reviewers_pictures lft">
	  <?php foreach( $latest_avatars as $latest_avatar ) { ?>
		  <div class="famous_reviewers_picture lft">
			  <img class="listar-background-cover-image avatar image" src="<?php echo esc_attr( $listar_blank_placeholder ); ?>" style="background-image:url(<?php echo esc_url( $latest_avatar ); ?>);" data-original="<?php echo $latest_avatar; ?>" style="display: block;">
			</div>
		<?php } ?>
