...
<div class="wcfmmp_sold_by_container_advanced">
  ...
  <div class="wcfmmp_sold_by_container_left">
    <?php if( apply_filters( 'wcfmmp_is_allow_single_product_sold_by_logo', true ) ) { ?>
		<img class="listar-background-cover-image" src="<?php echo esc_attr( $listar_blank_placeholder ); ?>" style="background-image:url(<?php echo esc_url( $store_logo ); ?>);" alt="user"/>
    <?php } ?>
  </div>
