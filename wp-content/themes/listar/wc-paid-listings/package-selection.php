...
if ( $packages || $user_packages ) :
	...
	if ( $has_valid_user_package ) :
		$checked = $get_package ? 0 : 1;
		?>
		<h2 class="listar-margin-bottom-40 text-center hidden">
			<?php esc_html_e( 'Your Packages:', 'listar' ); ?>
		</h2>

		<div class="row <?php echo sanitize_html_class( $listar_pricing_design ); ?> listar-user-packages hidden">
			<div class="col-sm-12">
						...
						if ( '0' !== $listar_current_post_id ) :
							...
							<div class="col-xs-12 col-sm-6 col-md-4 listar-package-standard-form listar-listing-package <?php echo esc_attr( listar_sanitize_html_class( $listar_has_tag ) ); ?>">
								<div class="listar-package-content listar-package-clickable-area">
									<div class="listar-owned-plan">
										<?php esc_html_e( 'Owned', 'listar' ); ?>
									</div>
									...
									<div class="listar-package-content-inner">
										...
										<div class="listar-package-description">
											...
											<p>	
												...
												if ( $package->get_duration() && ! $listar_condition_has_description && empty( $enabled_package_options_output ) ) {
	...
	<?php if ( $packages ) :
		...
		$header_title = $is_claiming_listing ? esc_html__( 'Claim Package(s):', 'listar' ) : esc_html__( 'Select Package:', 'listar' );
		?>
		<h2 class="listar-margin-bottom-40 text-center">
			<?php echo esc_html( $header_title ); ?>
		</h2>

		<div class="row <?php echo sanitize_html_class( $listar_pricing_design ); ?> listar-available-packages">
			<div class="col-sm-12">
								...
								<div class="listar-package-content-inner">
									...
									<div class="listar-package-description">
										...
										if ( $listar_condition_has_description ) :
											...
											if ( empty( $enabled_package_options_output ) ) :
												echo '<p>';

												if ( ! $is_claiming_listing ) :
													printf(
														_n(
															'For %s listing',
															'For %s listings',
