...
$listar_is_single     = is_single();
$listar_related_title = '';
$listar_is_archive    = $listar_is_single ? '' : 'listar-related-listing-archive';

if ( $listar_is_single ) {
	$listar_related_title = esc_html( get_option( 'listar_related_listings_title' ) );
} else {
	$listar_related_title = esc_html( get_option( 'listar_related_listings_archive_title' ) );
}
...
$listar_exec_query = new WP_Query(
	array(
		'post_type'      => 'job_listing',
		'post_status'    => 'publish',
		'post__not_in'   => listar_static_posts_already_shown(),
		'orderby'        => 'rand',
		'posts_per_page' => 3,
	)
);
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="listar-related-listings <?php echo esc_attr( sanitize_html_class( $listar_is_archive ) ); ?>" data-aos="fade-up">
							<div>
								<div class="row">
