<?php
/**
 * Template part for displaying related listings for archive pages
 *
...
$listar_is_archive    = 'listar-related-listing-archive';
...
$listar_exec_query = listar_get_related_listings_archive();
