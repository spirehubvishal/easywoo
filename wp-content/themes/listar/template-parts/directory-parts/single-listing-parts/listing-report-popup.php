<?php
/**
 * Template part for displaying the Report Listing popup
 *
...
$listar_search_by_background_image = listar_image_url( get_option( 'listar_complaint_report_background_image' ), 'listar-cover' );
$listar_background_image_mobile    = listar_image_url( get_option( 'listar_complaint_report_background_image' ), listar_mobile_hero_image_size() );
...
$search_by_popup_title             = esc_html__( 'Report', 'listar' );
?>

<!-- Start Report Listing Popup -->
<div class="listar-report-popup listar-hero-header listar-transparent-design <?php echo esc_attr( listar_sanitize_html_class( $listar_has_background_image ) ); ?>">
	<!-- Hero Image -->
				...
				<div class="panel listar-panel-form">
					...
					<div class="panel-body">
						<div>
							<div>
								<?php
								/* Report Listing form - 'Listar Add-ons' plugin */
								do_action( 'listar_report_form' );
								?>
							</div>
						</div>
					</div>
