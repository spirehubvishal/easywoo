...
get_header( 'shop' ); ?>
	...
	$listar_sidebar = 'shop-product';

	if ( empty( $input ) ) {
		$input = 'disabled';
	} elseif ( 'archive' === $input ) {
	...
	$listar_has_sidebar = is_active_sidebar( $listar_sidebar ) && is_dynamic_sidebar( $listar_sidebar ) && 'disabled' !== $input  ? true : false;
