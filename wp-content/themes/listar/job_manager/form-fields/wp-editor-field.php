...
$text_editor = 1 === (int) get_option( 'listar_use_code_editor_frontend' ) ? true : false;
...
$editor = apply_filters(
	...
	[
		...
		'tinymce'       => [
			...
			'toolbar1'                      => 'bold,italic,|,bullist,numlist,|,link,unlink,|,undo,redo,|alignleft,aligncenter,alignright',
			'toolbar2'                      => '',
			'toolbar3'                      => '',
			'toolbar4'                      => '',
		],
