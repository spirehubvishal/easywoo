...
$img_output = $media_full_res;
$listar_blank_placeholder = listar_blank_base64_placeholder_image();

if ( isset( $media_all_sizes_json['640'] ) && ! empty( $media_all_sizes_json['640'] ) ) {
	$img_output = $media_all_sizes_json['640'];
}
...
?>
<div class="listar-sbi_item sbi_type_<?php echo esc_attr( $media_type ); ?><?php echo esc_attr( $classes ); ?>" id="sbi_<?php echo esc_html( $post_id ); ?>" data-date="<?php echo esc_html( $timestamp ); ?>">
    <div class="sbi_photo_wrap">
        <a class="sbi_photo" href="<?php echo esc_url( $permalink ); ?>" target="_blank" rel="noopener" data-full-res="<?php echo esc_url( $media_full_res ); ?>" data-img-src-set="<?php echo esc_attr( wp_json_encode( $media_all_sizes_json ) ); ?>"<?php echo $sbi_photo_style_element; ?>>
            ...
            <div class="listar-instagram-feed-image" data-temp-background-image="<?php echo esc_url( $img_output ); ?>" data-src="<?php echo esc_attr( $listar_blank_placeholder ); ?>" data-alt="<?php echo esc_attr( $img_alt ); ?>" data-force-img="true" ></div>
        </a>
    </div>
</div>